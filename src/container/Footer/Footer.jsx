...
const Footer = () => {
  ...
  return (
    <>
      <h2 className='head-text'>Ask for important information Come up  & Chat With Me.</h2>
      <div className='app__footer-cards'>
        <div className='app__footer-card'>
          <img src={images.email} alt="email" />
          <a href="mailto:naveen901025@gmail.com" className='p-text'>naveen901025@gmail.com</a>
        </div>

        <div className='app__footer-card'>
          <img src={images.mobile} alt="email" />
          <a href="tel: +1 (123) 456-789" className='p-text'>9010255213</a>
        </div>
      </div>
